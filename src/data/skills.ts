export const skills = [
  {
    ...
    description: "Securización de equipos y servidores, manejo de herramientas forenses (FTK Imager, Autopsy, Lime, Volatility), gestión de seguridad con WAZUH y pfSense.",
  },
  {
    ...
    description: "Manejo de máquinas virtuales en VirtualBox y VMware, administración de sistemas Linux y Windows, control de versiones con Git y gestión de redes.",
  },
  {
    ...
    description: "Automatización de procesos con Python, desarrollo de scripts para optimización de tareas en bash.",
  },
  {
    ...
    title: "Idiomas",
    description: "Inglés fluido, capacidad para trabajar en entornos internacionales.",
  }
];
